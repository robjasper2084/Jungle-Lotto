...
export function migrateState(value:any):GameState{if(!value.settings)value.settings={reducedMotion:false,particles:true,highContrast:false,textScale:1,muted:true};value.rulesetVersion=RULESET_VERSION;return value as GameState;}
