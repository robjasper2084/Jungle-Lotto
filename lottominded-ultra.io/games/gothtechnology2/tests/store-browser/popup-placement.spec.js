...
test('game popup placement: About opens Swoop once and Collections retains Elmwood below collections',async({page})=>{
 await page.route('**/arcade/swoop-detroit/',route=>route.fulfill({contentType:'text/html',body:stub}));
 await page.clock.install();await page.goto(base+'about/');await page.clock.fastForward(2000);
