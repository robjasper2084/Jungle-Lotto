...
const seeds = [
  ...
  { handle: 'boogie-man-knit-sweater', title: 'The Boogie Man Knit Sweater', subtitle: 'Supplied knit design / armory campaign concept', dollars: 0, pricePending: true, type: 'Apparel', collection: 'black-signal', character: 'KALYX', cardImage: { ...reference('boogie-man-knit-sweater-campaign', 'The Boogie Man patterned knit sweater displayed on a black stone pedestal in a gold-lit cathedral armory', 'Armory campaign concept'), width: 1600, height: 900 }, images: [{ ...reference('boogie-man-knit-sweater-campaign', 'The Boogie Man patterned knit sweater displayed on a black stone pedestal in a gold-lit cathedral armory', 'Armory campaign concept'), width: 1600, height: 900 }, { ...reference('boogie-man-knit-sweater-supplied', 'Supplied front view of a blue Boogie Man knit sweater with city skylines, moons, stars and orange waveform motifs on a wood background', 'Supplied design reference'), width: 1600, height: 893 }], colors: ['As shown'], sizes: ['Size pending'], description: 'A supplied Boogie Man knit sweater concept, restaged as armory campaign artwork. Final materials, sizing, price, production, and availability await owner confirmation.' },
