/** Fragrance packaging concepts created for the Armory, not approved scent formulas. */
export const fragranceCollection = {
  handle: 'armory-fragrance-roller-collection',
  ...
  images: [
    ...
    { src: 'media/armory-fragrance-tiered-display-campaign.webp', alt: 'Armory fragrance roller packaging concepts arranged on tiered black metal platforms in a gold-lit alcove', label: 'Tiered display campaign concept', width: 1600, height: 1600 },
    { src: 'media/armory-fragrance-circuit-grid-campaign.webp', alt: 'Top-down campaign composition of Armory fragrance roller bottles on a gold circuit grid with cyan details', label: 'Circuit-grid campaign study', width: 1600, height: 1600 },
  ],
};
