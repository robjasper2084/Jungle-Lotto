...
import { ATTACKS } from "../config/moves.js?v=game-select-title12-boerboel-detroit";
...
import { attackIntentFromActions, resolveCancelAttack } from "./commands.js?v=game-select-title12-boerboel-detroit";
