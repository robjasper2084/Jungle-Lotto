...
import { FloatingText, LovePulseEffect, SpriteEffect } from "./effects.js?v=heartline35-detroit-title";
import { registerAttackHit, sliceAttackForHit } from "./hits.js?v=heartline35-detroit-title";
