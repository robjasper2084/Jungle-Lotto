...
import { LovePulseEffect, SpriteEffect } from "./effects.js?v=heartline40-original-plus-amara";
import { sliceAttackForHit } from "./hits.js?v=heartline40-original-plus-amara";
