...
import { COMMAND_LISTS, GAME_MODES, ROSTER_IDS } from "./config/content.js?v=game-select-title12-boerboel-detroit";
import { GothTechnologyGame } from "./scenes/game.js?v=game-select-title12-boerboel-detroit";
