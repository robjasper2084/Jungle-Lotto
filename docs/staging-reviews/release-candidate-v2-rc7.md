# Release Candidate v2-rc7 Review

- Review date: 2026-08-09
- Branch: `upgrade-redesign`
- Candidate SHA: immutable target of annotated tag `v2-rc7`
...
- Candidate tag: `v2-rc7`
- Approval status: **Ready for production review**

`v2-rc7` differs from `v2-rc6` only by normalizing the final newline in `docs/staging-reviews/secure-account-architecture.md` and refreshing the release evidence. Application source and reviewed visual output are unchanged. Critical release audits were rerun against this corrected candidate.
