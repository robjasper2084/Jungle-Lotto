...
- Static staging artifact: 28 noindexed pages and 636 same-origin references passed.
...
The News static build caches publisher-supplied article imagery locally. The corrected visual sign-off recorded zero external-asset warnings and zero same-origin asset failures.
