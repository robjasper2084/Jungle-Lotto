...
export const ASSET_URLS = {
  ...
  musicMenu: `${LOCAL_ROOT}/audio/lottomind-frequency.mp3`,
  musicFight: `${LOCAL_ROOT}/audio/lottomind-vault-174.mp3`,
  effects: {
...
export const FIGHTERS = {
  KALYX: {
    ...
    jumpVelocity: -935,
    feel: {
      attackStartupScale: 0.78,
      attackRecoveryScale: 0.68,
      attackActiveScale: 0.94,
      inputBuffer: 0.16,
      groundAccel: 2900,
      groundDecel: 2500,
      airAccel: 940,
